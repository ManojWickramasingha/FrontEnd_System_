    ...
    return (
        <div className='pageTemplate2'>
            <div className='bg-gray-200 min-h-screen'>
                <h1 className='text-6xl  text-center pt-6  text-green-500'>Expense Tracker</h1>
                                ...
                                {transactions.map((t) => (
                                    <tr key={t.id} >
                                        ...
                                        <td className='w-full md:w-1/4 px-2 py-4'>
                                            <button className='bg-green-500 px-2 py-2 text-white mr-1' onClick={() => handleEdit(t)}>Edit</button>
                                            <button className='bg-red-500 px-2 py-2 text-white' onClick={() => handleDelete(t.id)}>Delete</button>
                                        </td>
                                    </tr>
                                ))}
                            </tbody>
